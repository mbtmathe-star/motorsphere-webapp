    ...
    <section className="mb-10">
      ...
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[13px] font-semibold text-[#687589]">Promoted listings</span>
        </div>
        <Link href="/advertise" className="text-[12px] font-bold text-[#0866ff] hover:underline shrink-0">
          Advertise here &rarr;
        </Link>
      </div>
      ...
      <div className="ms-rail gap-4">
        {sponsoredListings.map(listing => (
          <Link
            ...
            className="flex-none snap-start block w-[310px] h-[210px] rounded-[20px] overflow-hidden relative group"
