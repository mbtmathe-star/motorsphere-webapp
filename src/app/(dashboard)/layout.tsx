...
const NAV_BY_ROLE: Record<string, { label: string; href: string; highlight?: boolean }[]> = {
  ...
  seller: [
    { label: 'Overview',       href: '/dashboard' },
    { label: 'Seller Hub',     href: '/dashboard/seller' },
  ...
  dealer: [
    { label: 'Overview',      href: '/dashboard' },
    { label: 'Dealer Hub',    href: '/dashboard/dealer' },
    { label: 'My stock',      href: '/dashboard/listings' },
  ...
  vendor: [
    { label: 'Overview',      href: '/dashboard' },
    { label: 'Vendor Hub',    href: '/dashboard/vendor' },
    { label: 'My inventory',  href: '/dashboard/listings' },
    { label: 'List a part',   href: '/listings/new' },
  ...
  workshop: [
    { label: 'Overview',       href: '/dashboard' },
    { label: 'Workshop Hub',   href: '/dashboard/workshop' },
    { label: 'My services',    href: '/dashboard/listings' },
    { label: 'Add service',    href: '/listings/new' },
    { label: 'Bookings',       href: '/inquiries' },
    { label: 'Verification',   href: '/dashboard/verification', highlight: true },
    { label: 'Profile',        href: '/profile' },
  ],
  admin: [
